...
# ml_workflow_pipeline documentation build
...
from ml_workflow_pipeline import __version__ as release

# -- Project information -----------------------------------------------------

project = "ml_workflow_pipeline"
author = "QuantumBlack"
...
htmlhelp_basename = "ml_workflow_pipelinedoc"
...
latex_documents = [
    (
        master_doc,
        "ml_workflow_pipeline.tex",
        "ml_workflow_pipeline Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "ml_workflow_pipeline",
        "Project ml_workflow_pipeline codebase.",
        "Data-Science",
    )
]
